...
def plot_mlp_batchnorm():
    # load data
    with open('results/2019-04-21_22-01-30_mlp_batchnorm_results.pkl', 'rb') as file:
        data = pickle.load(file)
    ...
    fig.suptitle('Accuracy and Loss for the MLP Model Using Batch Normalization', fontsize=14)
    axs[0].legend(['Training', 'Testing'], loc='lower right')
